  ...
  async function saveChanges() {
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Something went wrong while submitting your changes."
      );
    } finally {
      setSaving(false);
    }
